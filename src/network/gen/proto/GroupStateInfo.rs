...
impl ::protobuf::Message for GroupStateInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.group_state != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.group_state);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.group_state != 0 {
            os.write_uint32(3, self.group_state)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    try_id\x18\x04\x20\x01(\rR\x07entryId\x12\x19\n\x08group_id\x18\x01\x20\
    \x01(\rR\x07groupId\x12\x1d\n\nplayer_uid\x18\x06\x20\x01(\rR\tplayerUid\
    \x12\x1f\n\x0bgroup_state\x18\x03\x20\x01(\rR\ngroupStateB\x15\n\x13emu.\
