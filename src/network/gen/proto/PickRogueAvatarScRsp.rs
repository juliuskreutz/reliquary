...
//! Generated file from `PickRogueAvatarScRsp.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_5_1;

// @@protoc_insertion_point(message:PickRogueAvatarScRsp)
...
impl<'a> ::std::default::Default for &'a PickRogueAvatarScRsp {
    fn default() -> &'a PickRogueAvatarScRsp {
        <PickRogueAvatarScRsp as ::protobuf::Message>::default_instance()
    }
}

impl PickRogueAvatarScRsp {
    pub fn new() -> PickRogueAvatarScRsp {
...
impl ::protobuf::Message for PickRogueAvatarScRsp {
    const NAME: &'static str = "PickRogueAvatarScRsp";
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(7, &self.base_avatar_list);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(7, &self.base_avatar_list)?;
    ...
    fn new() -> PickRogueAvatarScRsp {
        PickRogueAvatarScRsp::new()
    }
...
impl ::protobuf::MessageFull for PickRogueAvatarScRsp {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("PickRogueAvatarScRsp").unwrap()).clone()
    }
}

impl ::std::fmt::Display for PickRogueAvatarScRsp {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for PickRogueAvatarScRsp {
