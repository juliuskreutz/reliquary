...
impl ::protobuf::Message for ClientMail {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.expire_time != 0 {
            my_size += ::protobuf::rt::int64_size(3, self.expire_time);
        }
        if self.template_id != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.template_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.is_read != false {
            os.write_bool(13, self.is_read)?;
        }
        if self.expire_time != 0 {
            os.write_int64(3, self.expire_time)?;
        }
        if self.template_id != 0 {
            os.write_uint32(8, self.template_id)?;
        }
        if let Some(v) = self.attachment.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x17\n\x07is_read\x18\r\x20\x01(\x08R\x06isRead\x12\x1f\n\x0bexpire_time\
    \x18\x03\x20\x01(\x03R\nexpireTime\x12\x1f\n\x0btemplate_id\x18\x08\x20\
    \x01(\rR\ntemplateId\x12)\n\nattachment\x18\x0e\x20\x01(\x0b2\t.ItemList\
    R\nattachment\x12\x14\n\x05title\x18\x01\x20\x01(\tR\x05title\x12\x16\n\
    \x06sender\x18\x07\x20\x01(\tR\x06sender\x12\x1b\n\tpara_list\x18\t\x20\
    \x03(\tR\x08paraList\x12\x0e\n\x02id\x18\x0c\x20\x01(\rR\x02id\x12\x18\n\
    \x07content\x18\x0b\x20\x01(\tR\x07content\x12\x12\n\x04time\x18\x0f\x20\
    \x01(\x03R\x04timeB\x15\n\x13emu.lunarcore.protob\x06proto3\
";
