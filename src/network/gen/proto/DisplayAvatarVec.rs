...
impl ::protobuf::Message for DisplayAvatarVec {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.is_display != false {
            os.write_bool(8, self.is_display)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    vatarVec\x12>\n\x13display_avatar_list\x18\r\x20\x03(\x0b2\x0e.DisplayAv\
    atarR\x11displayAvatarList\x12\x1d\n\nis_display\x18\x08\x20\x01(\x08R\t\
