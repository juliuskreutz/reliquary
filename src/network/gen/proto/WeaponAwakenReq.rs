...
pub struct WeaponAwakenReq {
    ...
    // @@protoc_insertion_point(field:WeaponAwakenReq.affix_level_map)
    pub affix_level_map: ::std::collections::HashMap<u32, u32>,
    // @@protoc_insertion_point(field:WeaponAwakenReq.item_guid)
    pub item_guid: u64,
    // special fields
...
impl WeaponAwakenReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_map_simpler_accessor::<_, _, _>(
            "affix_level_map",
            |m: &WeaponAwakenReq| { &m.affix_level_map },
            |m: &mut WeaponAwakenReq| { &mut m.affix_level_map },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "item_guid",
            |m: &WeaponAwakenReq| { &m.item_guid },
            |m: &mut WeaponAwakenReq| { &mut m.item_guid },
        ));
...
impl ::protobuf::Message for WeaponAwakenReq {
        ...
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                34 => {
                    ...
                    self.affix_level_map.insert(key, value);
                },
                120 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.target_weapon_guid != 0 {
            my_size += ::protobuf::rt::uint64_size(2, self.target_weapon_guid);
        }
        for (k, v) in &self.affix_level_map {
        ...
        if self.item_guid != 0 {
            my_size += ::protobuf::rt::uint64_size(15, self.item_guid);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.target_weapon_guid != 0 {
            os.write_uint64(2, self.target_weapon_guid)?;
        }
        for (k, v) in &self.affix_level_map {
            let mut entry_size = 0;
            entry_size += ::protobuf::rt::uint32_size(1, *k);
        ...
        if self.item_guid != 0 {
            os.write_uint64(15, self.item_guid)?;
        }
    ...
    fn clear(&mut self) {
        ...
        self.affix_level_map.clear();
        self.item_guid = 0;
        self.special_fields.clear();
    }

    fn default_instance() -> &'static WeaponAwakenReq {
        static instance: ::protobuf::rt::Lazy<WeaponAwakenReq> = ::protobuf::rt::Lazy::new();
        instance.get(WeaponAwakenReq::new)
    }
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x15WeaponAwakenReq.proto\"\xeb\x01\n\x0fWeaponAwakenReq\x12,\n\x12tar\
    get_weapon_guid\x18\x02\x20\x01(\x04R\x10targetWeaponGuid\x12K\n\x0faffi\
    x_level_map\x18\x04\x20\x03(\x0b2#.WeaponAwakenReq.AffixLevelMapEntryR\r\
    affixLevelMap\x12\x1b\n\titem_guid\x18\x0f\x20\x01(\x04R\x08itemGuid\x1a\
    @\n\x12AffixLevelMapEntry\x12\x10\n\x03key\x18\x01\x20\x01(\rR\x03key\
