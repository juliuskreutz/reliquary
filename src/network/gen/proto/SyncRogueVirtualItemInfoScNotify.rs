...
//! Generated file from `SyncRogueVirtualItemInfoScNotify.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_5_1;

// @@protoc_insertion_point(message:SyncRogueVirtualItemInfoScNotify)
...
impl<'a> ::std::default::Default for &'a SyncRogueVirtualItemInfoScNotify {
    fn default() -> &'a SyncRogueVirtualItemInfoScNotify {
        <SyncRogueVirtualItemInfoScNotify as ::protobuf::Message>::default_instance()
    }
}

impl SyncRogueVirtualItemInfoScNotify {
    pub fn new() -> SyncRogueVirtualItemInfoScNotify {
...
impl ::protobuf::Message for SyncRogueVirtualItemInfoScNotify {
    const NAME: &'static str = "SyncRogueVirtualItemInfoScNotify";
    ...
    fn new() -> SyncRogueVirtualItemInfoScNotify {
        SyncRogueVirtualItemInfoScNotify::new()
    }
...
impl ::protobuf::MessageFull for SyncRogueVirtualItemInfoScNotify {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("SyncRogueVirtualItemInfoScNotify").unwrap()).clone()
    }
}

impl ::std::fmt::Display for SyncRogueVirtualItemInfoScNotify {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for SyncRogueVirtualItemInfoScNotify {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    m_info\x18\x08\x20\x01(\x0b2\x15.RogueVirtualItemInfoR\x14rogueVirtualIt\
