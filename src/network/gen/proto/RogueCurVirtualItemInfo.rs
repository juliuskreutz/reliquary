...
//! Generated file from `RogueCurVirtualItemInfo.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_6_0;

// @@protoc_insertion_point(message:RogueCurVirtualItemInfo)
...
impl<'a> ::std::default::Default for &'a RogueCurVirtualItemInfo {
    fn default() -> &'a RogueCurVirtualItemInfo {
        <RogueCurVirtualItemInfo as ::protobuf::Message>::default_instance()
    }
}

impl RogueCurVirtualItemInfo {
    pub fn new() -> RogueCurVirtualItemInfo {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "cur_rogue_coin",
            |m: &RogueCurVirtualItemInfo| { &m.cur_rogue_coin },
...
impl ::protobuf::Message for RogueCurVirtualItemInfo {
    const NAME: &'static str = "RogueCurVirtualItemInfo";
    ...
    fn new() -> RogueCurVirtualItemInfo {
        RogueCurVirtualItemInfo::new()
    }
...
impl ::protobuf::MessageFull for RogueCurVirtualItemInfo {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("RogueCurVirtualItemInfo").unwrap()).clone()
    }
}

impl ::std::fmt::Display for RogueCurVirtualItemInfo {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for RogueCurVirtualItemInfo {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(RogueCurVirtualItemInfo::generated_message_descriptor_data());
