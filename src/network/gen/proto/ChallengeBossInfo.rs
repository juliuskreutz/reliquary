...
impl ::protobuf::Message for ChallengeBossInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(3, &self.lineup1);
        if self.ACGHCDLBCGD != false {
            my_size += 1 + 1;
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(12, &self.lineup2);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        os.write_repeated_packed_uint32(3, &self.lineup1)?;
        if self.ACGHCDLBCGD != false {
            os.write_bool(13, self.ACGHCDLBCGD)?;
        }
        os.write_repeated_packed_uint32(12, &self.lineup2)?;
