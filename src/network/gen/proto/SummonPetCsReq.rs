...
//! Generated file from `SummonPetCsReq.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_6_0;

// @@protoc_insertion_point(message:SummonPetCsReq)
...
impl<'a> ::std::default::Default for &'a SummonPetCsReq {
    fn default() -> &'a SummonPetCsReq {
        <SummonPetCsReq as ::protobuf::Message>::default_instance()
    }
}

impl SummonPetCsReq {
    pub fn new() -> SummonPetCsReq {
...
impl ::protobuf::Message for SummonPetCsReq {
    const NAME: &'static str = "SummonPetCsReq";
...
impl ::protobuf::MessageFull for SummonPetCsReq {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("SummonPetCsReq").unwrap()).clone()
    }
}

impl ::std::fmt::Display for SummonPetCsReq {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for SummonPetCsReq {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}

static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x14SummonPetCsReq.proto\"8\n\x0eSummonPetCsReq\x12&\n\x0fsummoned_pet\
    _id\x18\n\x20\x01(\rR\rsummonedPetIdB\x15\n\x13emu.lunarcore.protob\x06p\
    roto3\
";
