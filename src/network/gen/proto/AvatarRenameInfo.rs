...
//! Generated file from `AvatarRenameInfo.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_4_0;

// @@protoc_insertion_point(message:AvatarRenameInfo)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct AvatarRenameInfo {
    // message fields
    // @@protoc_insertion_point(field:AvatarRenameInfo.avatar_name)
    pub avatar_name: ::std::string::String,
    // @@protoc_insertion_point(field:AvatarRenameInfo.avatar_id)
    pub avatar_id: u32,
    // special fields
    // @@protoc_insertion_point(special_field:AvatarRenameInfo.special_fields)
...
impl ::protobuf::Message for AvatarRenameInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.avatar_name.is_empty() {
            my_size += ::protobuf::rt::string_size(13, &self.avatar_name);
        }
        if self.avatar_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if !self.avatar_name.is_empty() {
            os.write_string(13, &self.avatar_name)?;
        }
        if self.avatar_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x16AvatarRenameInfo.proto\"P\n\x10AvatarRenameInfo\x12\x1f\n\x0bavata\
    r_name\x18\r\x20\x01(\tR\navatarName\x12\x1b\n\tavatar_id\x18\x03\x20\
