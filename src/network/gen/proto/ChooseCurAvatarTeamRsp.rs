...
impl ::protobuf::Message for ChooseCurAvatarTeamRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.cur_team_id != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.cur_team_id);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.cur_team_id != 0 {
            os.write_uint32(10, self.cur_team_id)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x1e\n\x0bcur_team_id\x18\n\x20\x01(\rR\tcurTeamId\x12\x18\n\x07retcode\
    \x18\x02\x20\x01(\x05R\x07retcodeB\x1b\n\x19emu.grasscutter.net.protob\
    \x06proto3\
";
