...
pub struct PickRogueAvatarCsReq {
    // message fields
    // @@protoc_insertion_point(field:PickRogueAvatarCsReq.base_avatar_list)
...
impl PickRogueAvatarCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "base_avatar_list",
            |m: &PickRogueAvatarCsReq| { &m.base_avatar_list },
            |m: &mut PickRogueAvatarCsReq| { &mut m.base_avatar_list },
        ));
...
impl ::protobuf::Message for PickRogueAvatarCsReq {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(2, &self.base_avatar_list);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(2, &self.base_avatar_list)?;
