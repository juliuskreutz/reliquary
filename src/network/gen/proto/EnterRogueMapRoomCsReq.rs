...
//! Generated file from `EnterRogueMapRoomCsReq.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_6_0;

// @@protoc_insertion_point(message:EnterRogueMapRoomCsReq)
...
impl<'a> ::std::default::Default for &'a EnterRogueMapRoomCsReq {
    fn default() -> &'a EnterRogueMapRoomCsReq {
        <EnterRogueMapRoomCsReq as ::protobuf::Message>::default_instance()
    }
}

impl EnterRogueMapRoomCsReq {
    pub fn new() -> EnterRogueMapRoomCsReq {
...
impl ::protobuf::Message for EnterRogueMapRoomCsReq {
    const NAME: &'static str = "EnterRogueMapRoomCsReq";
    ...
    fn new() -> EnterRogueMapRoomCsReq {
        EnterRogueMapRoomCsReq::new()
    }
...
impl ::protobuf::MessageFull for EnterRogueMapRoomCsReq {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("EnterRogueMapRoomCsReq").unwrap()).clone()
    }
}

impl ::std::fmt::Display for EnterRogueMapRoomCsReq {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for EnterRogueMapRoomCsReq {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}

static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1cEnterRogueMapRoomCsReq.proto\"J\n\x16EnterRogueMapRoomCsReq\x12\
    \x17\n\x07room_id\x18\t\x20\x01(\rR\x06roomId\x12\x17\n\x07site_id\x18\
    \x01\x20\x01(\rR\x06siteIdB\x15\n\x13emu.lunarcore.protob\x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(EnterRogueMapRoomCsReq::generated_message_descriptor_data());
