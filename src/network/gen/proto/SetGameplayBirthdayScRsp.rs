...
//! Generated file from `SetGameplayBirthdayScRsp.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_6_0;

// @@protoc_insertion_point(message:SetGameplayBirthdayScRsp)
...
impl<'a> ::std::default::Default for &'a SetGameplayBirthdayScRsp {
    fn default() -> &'a SetGameplayBirthdayScRsp {
        <SetGameplayBirthdayScRsp as ::protobuf::Message>::default_instance()
    }
}

impl SetGameplayBirthdayScRsp {
    pub fn new() -> SetGameplayBirthdayScRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "retcode",
            |m: &SetGameplayBirthdayScRsp| { &m.retcode },
...
impl ::protobuf::Message for SetGameplayBirthdayScRsp {
    const NAME: &'static str = "SetGameplayBirthdayScRsp";
    ...
    fn new() -> SetGameplayBirthdayScRsp {
        SetGameplayBirthdayScRsp::new()
    }
...
impl ::protobuf::MessageFull for SetGameplayBirthdayScRsp {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("SetGameplayBirthdayScRsp").unwrap()).clone()
    }
}

impl ::std::fmt::Display for SetGameplayBirthdayScRsp {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for SetGameplayBirthdayScRsp {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(SetGameplayBirthdayScRsp::generated_message_descriptor_data());
