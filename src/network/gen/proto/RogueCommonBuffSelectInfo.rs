...
impl ::protobuf::Message for RogueCommonBuffSelectInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(2, &self.first_buff_type_list);
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(3, &self.handbook_unlock_buff_id_list);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        os.write_repeated_packed_uint32(2, &self.first_buff_type_list)?;
        if self.roll_buff_times != 0 {
        ...
        os.write_repeated_packed_uint32(3, &self.handbook_unlock_buff_id_list)?;
        if self.certain_select_buff_id != 0 {
