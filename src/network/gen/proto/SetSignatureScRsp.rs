...
//! Generated file from `SetSignatureScRsp.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_6_0;

// @@protoc_insertion_point(message:SetSignatureScRsp)
...
impl<'a> ::std::default::Default for &'a SetSignatureScRsp {
    fn default() -> &'a SetSignatureScRsp {
        <SetSignatureScRsp as ::protobuf::Message>::default_instance()
    }
}

impl SetSignatureScRsp {
    pub fn new() -> SetSignatureScRsp {
...
impl ::protobuf::Message for SetSignatureScRsp {
    const NAME: &'static str = "SetSignatureScRsp";
    ...
    fn new() -> SetSignatureScRsp {
        SetSignatureScRsp::new()
    }
...
impl ::protobuf::MessageFull for SetSignatureScRsp {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("SetSignatureScRsp").unwrap()).clone()
    }
}

impl ::std::fmt::Display for SetSignatureScRsp {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for SetSignatureScRsp {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}

static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x17SetSignatureScRsp.proto\"K\n\x11SetSignatureScRsp\x12\x18\n\x07ret\
    code\x18\x0f\x20\x01(\rR\x07retcode\x12\x1c\n\tsignature\x18\n\x20\x01(\
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(SetSignatureScRsp::generated_message_descriptor_data());
