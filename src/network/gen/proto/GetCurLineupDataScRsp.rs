...
//! Generated file from `GetCurLineupDataScRsp.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_6_0;

// @@protoc_insertion_point(message:GetCurLineupDataScRsp)
...
impl<'a> ::std::default::Default for &'a GetCurLineupDataScRsp {
    fn default() -> &'a GetCurLineupDataScRsp {
        <GetCurLineupDataScRsp as ::protobuf::Message>::default_instance()
    }
}

impl GetCurLineupDataScRsp {
    pub fn new() -> GetCurLineupDataScRsp {
...
impl ::protobuf::Message for GetCurLineupDataScRsp {
    const NAME: &'static str = "GetCurLineupDataScRsp";
    ...
    fn new() -> GetCurLineupDataScRsp {
        GetCurLineupDataScRsp::new()
    }
...
impl ::protobuf::MessageFull for GetCurLineupDataScRsp {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("GetCurLineupDataScRsp").unwrap()).clone()
    }
}

impl ::std::fmt::Display for GetCurLineupDataScRsp {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for GetCurLineupDataScRsp {
