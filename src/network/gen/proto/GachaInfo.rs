...
pub struct GachaInfo {
    // message fields
    // @@protoc_insertion_point(field:GachaInfo.current_gacha_time)
...
impl GachaInfo {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "current_gacha_time",
            |m: &GachaInfo| { &m.current_gacha_time },
            |m: &mut GachaInfo| { &mut m.current_gacha_time },
        ));
...
impl ::protobuf::Message for GachaInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.current_gacha_time != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.current_gacha_time);
        }
        if let Some(v) = self.gacha_ceiling.as_ref() {
            let len = v.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(2, &self.up_info);
        if self.gacha_id != 0 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(4, &self.featured);
        if !self.history_url.is_empty() {
            my_size += ::protobuf::rt::string_size(10, &self.history_url);
        }
        if self.end_time != 0 {
            my_size += ::protobuf::rt::int64_size(5, self.end_time);
        }
        if !self.detail_url.is_empty() {
            my_size += ::protobuf::rt::string_size(9, &self.detail_url);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.current_gacha_time != 0 {
            os.write_uint32(13, self.current_gacha_time)?;
        }
        if let Some(v) = self.gacha_ceiling.as_ref() {
            ::protobuf::rt::write_message_field_with_cached_size(15, v, os)?;
        }
        os.write_repeated_packed_uint32(2, &self.up_info)?;
        if self.gacha_id != 0 {
        ...
        os.write_repeated_packed_uint32(4, &self.featured)?;
        if !self.history_url.is_empty() {
            os.write_string(10, &self.history_url)?;
        }
        if self.end_time != 0 {
            os.write_int64(5, self.end_time)?;
        }
        if !self.detail_url.is_empty() {
            os.write_string(9, &self.detail_url)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x0fGachaInfo.proto\x1a\x12GachaCeiling.proto\"\xb7\x02\n\tGachaInfo\
    \x12,\n\x12current_gacha_time\x18\r\x20\x01(\rR\x10currentGachaTime\x122\
    \n\rgacha_ceiling\x18\x0f\x20\x01(\x0b2\r.GachaCeilingR\x0cgachaCeiling\
    \x12\x17\n\x07up_info\x18\x02\x20\x03(\rR\x06upInfo\x12\x19\n\x08gacha_i\
    d\x18\x0b\x20\x01(\rR\x07gachaId\x12\x1d\n\nbegin_time\x18\x06\x20\x01(\
    \x03R\tbeginTime\x12\x1a\n\x08featured\x18\x04\x20\x03(\rR\x08featured\
    \x12\x1f\n\x0bhistory_url\x18\n\x20\x01(\tR\nhistoryUrl\x12\x19\n\x08end\
    _time\x18\x05\x20\x01(\x03R\x07endTime\x12\x1d\n\ndetail_url\x18\t\x20\
