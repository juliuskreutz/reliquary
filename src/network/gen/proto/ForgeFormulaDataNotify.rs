...
impl ::protobuf::Message for ForgeFormulaDataNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.forge_id != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.forge_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.forge_id != 0 {
            os.write_uint32(2, self.forge_id)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x1b\n\tis_locked\x18\x04\x20\x01(\x08R\x08isLocked\x12\x19\n\x08forge_i\
    d\x18\x02\x20\x01(\rR\x07forgeIdB\x1b\n\x19emu.grasscutter.net.protob\
    \x06proto3\
";
