...
//! Generated file from `AvatarTeam.proto`
...
impl ::protobuf::Message for AvatarTeam {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.team_name.is_empty() {
            my_size += ::protobuf::rt::string_size(1, &self.team_name);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if !self.team_name.is_empty() {
            os.write_string(1, &self.team_name)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x10AvatarTeam.proto\"S\n\nAvatarTeam\x12(\n\x10avatar_guid_list\x18\
    \x05\x20\x03(\x04R\x0eavatarGuidList\x12\x1b\n\tteam_name\x18\x01\x20\
    \x01(\tR\x08teamNameB\x1b\n\x19emu.grasscutter.net.protob\x06proto3\
";
