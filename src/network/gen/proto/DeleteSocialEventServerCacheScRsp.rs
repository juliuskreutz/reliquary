...
impl ::protobuf::Message for DeleteSocialEventServerCacheScRsp {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(1, &self.ret_delete_cache);
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(1, &self.ret_delete_cache)?;
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    acheScRsp\x12(\n\x10ret_delete_cache\x18\x01\x20\x03(\rR\x0eretDeleteCac\
