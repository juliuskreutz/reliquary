...
//! Generated file from `ExpUpEquipmentScRsp.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_6_0;

// @@protoc_insertion_point(message:ExpUpEquipmentScRsp)
...
impl<'a> ::std::default::Default for &'a ExpUpEquipmentScRsp {
    fn default() -> &'a ExpUpEquipmentScRsp {
        <ExpUpEquipmentScRsp as ::protobuf::Message>::default_instance()
    }
}

impl ExpUpEquipmentScRsp {
    pub fn new() -> ExpUpEquipmentScRsp {
...
impl ::protobuf::Message for ExpUpEquipmentScRsp {
    const NAME: &'static str = "ExpUpEquipmentScRsp";
    ...
    fn new() -> ExpUpEquipmentScRsp {
        ExpUpEquipmentScRsp::new()
    }
...
impl ::protobuf::MessageFull for ExpUpEquipmentScRsp {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("ExpUpEquipmentScRsp").unwrap()).clone()
    }
}

impl ::std::fmt::Display for ExpUpEquipmentScRsp {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for ExpUpEquipmentScRsp {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}

static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x19ExpUpEquipmentScRsp.proto\x1a\x0ePileItem.proto\"d\n\x13ExpUpEquip\
    mentScRsp\x123\n\x10return_item_list\x18\x05\x20\x03(\x0b2\t.PileItemR\
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(ExpUpEquipmentScRsp::generated_message_descriptor_data());
