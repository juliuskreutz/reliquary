...
//! Generated file from `RogueSyncContextBoardEvent.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_6_0;

// @@protoc_insertion_point(message:RogueSyncContextBoardEvent)
...
impl<'a> ::std::default::Default for &'a RogueSyncContextBoardEvent {
    fn default() -> &'a RogueSyncContextBoardEvent {
        <RogueSyncContextBoardEvent as ::protobuf::Message>::default_instance()
    }
}

impl RogueSyncContextBoardEvent {
    pub fn new() -> RogueSyncContextBoardEvent {
...
impl ::protobuf::Message for RogueSyncContextBoardEvent {
    const NAME: &'static str = "RogueSyncContextBoardEvent";
    ...
    fn new() -> RogueSyncContextBoardEvent {
        RogueSyncContextBoardEvent::new()
    }
...
impl ::protobuf::MessageFull for RogueSyncContextBoardEvent {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("RogueSyncContextBoardEvent").unwrap()).clone()
    }
}

impl ::std::fmt::Display for RogueSyncContextBoardEvent {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for RogueSyncContextBoardEvent {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(RogueSyncContextBoardEvent::generated_message_descriptor_data());
