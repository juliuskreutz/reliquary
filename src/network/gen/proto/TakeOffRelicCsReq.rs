...
impl ::protobuf::Message for TakeOffRelicCsReq {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(15, &self.slot_list);
        if self.avatar_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(15, &self.slot_list)?;
        if self.avatar_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    list\x18\x0f\x20\x03(\rR\x08slotList\x12\x1b\n\tavatar_id\x18\x0c\x20\
    \x01(\rR\x08avatarIdB\x15\n\x13emu.lunarcore.protob\x06proto3\
";
