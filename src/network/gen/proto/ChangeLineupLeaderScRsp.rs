...
//! Generated file from `ChangeLineupLeaderScRsp.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_6_0;

// @@protoc_insertion_point(message:ChangeLineupLeaderScRsp)
...
impl<'a> ::std::default::Default for &'a ChangeLineupLeaderScRsp {
    fn default() -> &'a ChangeLineupLeaderScRsp {
        <ChangeLineupLeaderScRsp as ::protobuf::Message>::default_instance()
    }
}

impl ChangeLineupLeaderScRsp {
    pub fn new() -> ChangeLineupLeaderScRsp {
...
impl ::protobuf::Message for ChangeLineupLeaderScRsp {
    const NAME: &'static str = "ChangeLineupLeaderScRsp";
    ...
    fn new() -> ChangeLineupLeaderScRsp {
        ChangeLineupLeaderScRsp::new()
    }
...
impl ::protobuf::MessageFull for ChangeLineupLeaderScRsp {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("ChangeLineupLeaderScRsp").unwrap()).clone()
    }
}

impl ::std::fmt::Display for ChangeLineupLeaderScRsp {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for ChangeLineupLeaderScRsp {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(ChangeLineupLeaderScRsp::generated_message_descriptor_data());
