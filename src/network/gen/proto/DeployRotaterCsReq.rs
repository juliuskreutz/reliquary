...
//! Generated file from `DeployRotaterCsReq.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_6_0;

// @@protoc_insertion_point(message:DeployRotaterCsReq)
...
impl<'a> ::std::default::Default for &'a DeployRotaterCsReq {
    fn default() -> &'a DeployRotaterCsReq {
        <DeployRotaterCsReq as ::protobuf::Message>::default_instance()
    }
}

impl DeployRotaterCsReq {
    pub fn new() -> DeployRotaterCsReq {
...
impl ::protobuf::Message for DeployRotaterCsReq {
    const NAME: &'static str = "DeployRotaterCsReq";
    ...
    fn new() -> DeployRotaterCsReq {
        DeployRotaterCsReq::new()
    }
...
impl ::protobuf::MessageFull for DeployRotaterCsReq {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("DeployRotaterCsReq").unwrap()).clone()
    }
}

impl ::std::fmt::Display for DeployRotaterCsReq {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for DeployRotaterCsReq {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}

static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x18DeployRotaterCsReq.proto\x1a\x11RotaterData.proto\"E\n\x12DeployRo\
    taterCsReq\x12/\n\x0crotater_data\x18\x0f\x20\x01(\x0b2\x0c.RotaterDataR\
