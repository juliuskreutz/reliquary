...
//! Generated file from `StoreType.proto`
...
pub enum StoreType {
    ...
    STORE_TYPE_NONE = 0,
    // @@protoc_insertion_point(enum_value:StoreType.STORE_TYPE_PACK)
    STORE_TYPE_PACK = 1,
    // @@protoc_insertion_point(enum_value:StoreType.STORE_TYPE_DEPOT)
    STORE_TYPE_DEPOT = 2,
}
...
impl ::protobuf::Enum for StoreType {
    ...
    fn from_i32(value: i32) -> ::std::option::Option<StoreType> {
        match value {
            ...
            1 => ::std::option::Option::Some(StoreType::STORE_TYPE_PACK),
            2 => ::std::option::Option::Some(StoreType::STORE_TYPE_DEPOT),
    ...
    fn from_str(str: &str) -> ::std::option::Option<StoreType> {
        match str {
            ...
            "STORE_TYPE_PACK" => ::std::option::Option::Some(StoreType::STORE_TYPE_PACK),
            "STORE_TYPE_DEPOT" => ::std::option::Option::Some(StoreType::STORE_TYPE_DEPOT),
            _ => ::std::option::Option::None
        }
    }
