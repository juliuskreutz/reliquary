...
impl ::protobuf::Message for SceneInitFinishRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.enter_scene_token != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.enter_scene_token);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.enter_scene_token != 0 {
            os.write_uint32(10, self.enter_scene_token)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    r_scene_token\x18\n\x20\x01(\rR\x0fenterSceneToken\x12\x18\n\x07retcode\
    \x18\x01\x20\x01(\x05R\x07retcodeB\x1b\n\x19emu.grasscutter.net.protob\
    \x06proto3\
";
