...
impl ::protobuf::Message for GadgetInteractRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.interact_type != ::protobuf::EnumOrUnknown::new(super::InteractType::InteractType::INTERACT_TYPE_NONE) {
            my_size += ::protobuf::rt::int32_size(3, self.interact_type.value());
        }
        ...
        if self.gadget_entity_id != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.gadget_entity_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.interact_type != ::protobuf::EnumOrUnknown::new(super::InteractType::InteractType::INTERACT_TYPE_NONE) {
            os.write_enum(3, ::protobuf::EnumOrUnknown::value(&self.interact_type))?;
        }
        if self.op_type != ::protobuf::EnumOrUnknown::new(super::InterOpType::InterOpType::INTER_OP_TYPE_FINISH) {
        ...
        if self.gadget_entity_id != 0 {
            os.write_uint32(10, self.gadget_entity_id)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x17GadgetInteractRsp.proto\x1a\x12InteractType.proto\x1a\x11InterOpTy\
    pe.proto\"\xcf\x01\n\x11GadgetInteractRsp\x122\n\rinteract_type\x18\x03\
    \x20\x01(\x0e2\r.InteractTypeR\x0cinteractType\x12%\n\x07op_type\x18\x04\
    \x20\x01(\x0e2\x0c.InterOpTypeR\x06opType\x12\x18\n\x07retcode\x18\x06\
    \x20\x01(\x05R\x07retcode\x12\x1b\n\tgadget_id\x18\x08\x20\x01(\rR\x08ga\
    dgetId\x12(\n\x10gadget_entity_id\x18\n\x20\x01(\rR\x0egadgetEntityIdB\
