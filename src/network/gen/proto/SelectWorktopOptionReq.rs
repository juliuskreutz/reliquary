...
impl ::protobuf::Message for SelectWorktopOptionReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.gadget_entity_id != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.gadget_entity_id);
        }
        if self.option_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.gadget_entity_id != 0 {
            os.write_uint32(4, self.gadget_entity_id)?;
        }
        if self.option_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1cSelectWorktopOptionReq.proto\"_\n\x16SelectWorktopOptionReq\x12(\n\
    \x10gadget_entity_id\x18\x04\x20\x01(\rR\x0egadgetEntityId\x12\x1b\n\top\
    tion_id\x18\n\x20\x01(\rR\x08optionIdB\x1b\n\x19emu.grasscutter.net.prot\
    ob\x06proto3\
";
