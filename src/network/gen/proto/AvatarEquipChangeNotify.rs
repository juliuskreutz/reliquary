...
impl ::protobuf::Message for AvatarEquipChangeNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.equip_type != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.equip_type);
        }
        ...
        if self.equip_guid != 0 {
            my_size += ::protobuf::rt::uint64_size(14, self.equip_guid);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.equip_type != 0 {
            os.write_uint32(1, self.equip_type)?;
        }
        if let Some(v) = self.weapon.as_ref() {
        ...
        if self.equip_guid != 0 {
            os.write_uint64(14, self.equip_guid)?;
        }
        if let Some(v) = self.reliquary.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    SceneReliquaryInfo.proto\"\xee\x01\n\x17AvatarEquipChangeNotify\x12\x1d\
    \n\nequip_type\x18\x01\x20\x01(\rR\tequipType\x12(\n\x06weapon\x18\x02\
    \x20\x01(\x0b2\x10.SceneWeaponInfoR\x06weapon\x12\x17\n\x07item_id\x18\t\
    \x20\x01(\rR\x06itemId\x12\x1f\n\x0bavatar_guid\x18\r\x20\x01(\x04R\nava\
    tarGuid\x12\x1d\n\nequip_guid\x18\x0e\x20\x01(\x04R\tequipGuid\x121\n\tr\
    eliquary\x18\x0f\x20\x01(\x0b2\x13.SceneReliquaryInfoR\treliquaryB\x1b\n\
