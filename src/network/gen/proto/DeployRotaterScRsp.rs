...
//! Generated file from `DeployRotaterScRsp.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_5_1;

// @@protoc_insertion_point(message:DeployRotaterScRsp)
...
impl<'a> ::std::default::Default for &'a DeployRotaterScRsp {
    fn default() -> &'a DeployRotaterScRsp {
        <DeployRotaterScRsp as ::protobuf::Message>::default_instance()
    }
}

impl DeployRotaterScRsp {
    pub fn new() -> DeployRotaterScRsp {
...
impl ::protobuf::Message for DeployRotaterScRsp {
    const NAME: &'static str = "DeployRotaterScRsp";
    ...
    fn new() -> DeployRotaterScRsp {
        DeployRotaterScRsp::new()
    }
...
impl ::protobuf::MessageFull for DeployRotaterScRsp {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("DeployRotaterScRsp").unwrap()).clone()
    }
}

impl ::std::fmt::Display for DeployRotaterScRsp {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for DeployRotaterScRsp {
