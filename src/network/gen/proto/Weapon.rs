...
pub struct Weapon {
    ...
    // @@protoc_insertion_point(field:Weapon.IEBDKIAOPGO)
    pub IEBDKIAOPGO: bool,
    // special fields
...
impl Weapon {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "IEBDKIAOPGO",
            |m: &Weapon| { &m.IEBDKIAOPGO },
            |m: &mut Weapon| { &mut m.IEBDKIAOPGO },
        ));
...
impl ::protobuf::Message for Weapon {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.IEBDKIAOPGO != false {
            os.write_bool(5, self.IEBDKIAOPGO)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x0cWeapon.proto\"\xe8\x01\n\x06Weapon\x12\x14\n\x05level\x18\x01\x20\
    \x01(\rR\x05level\x12\x10\n\x03exp\x18\x02\x20\x01(\rR\x03exp\x12#\n\rpr\
    omote_level\x18\x03\x20\x01(\rR\x0cpromoteLevel\x122\n\taffix_map\x18\
    \x04\x20\x03(\x0b2\x15.Weapon.AffixMapEntryR\x08affixMap\x12\x20\n\x0bIE\
    BDKIAOPGO\x18\x05\x20\x01(\x08R\x0bIEBDKIAOPGO\x1a;\n\rAffixMapEntry\x12\
