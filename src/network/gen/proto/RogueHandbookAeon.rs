...
impl ::protobuf::Message for RogueHandbookAeon {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.aeon_id != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.aeon_id);
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(11, &self.taken_reward_list);
        if self.max_level != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.max_level);
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(9, &self.archive_unlock_list);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.aeon_id != 0 {
            os.write_uint32(4, self.aeon_id)?;
        }
        os.write_repeated_packed_uint32(11, &self.taken_reward_list)?;
        if self.max_level != 0 {
            os.write_uint32(3, self.max_level)?;
        }
        os.write_repeated_packed_uint32(9, &self.archive_unlock_list)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x03exp\x18\x01\x20\x01(\rR\x03exp\x12\x14\n\x05level\x18\x02\x20\x01(\r\
    R\x05level\x12\x17\n\x07aeon_id\x18\x04\x20\x01(\rR\x06aeonId\x12*\n\x11\
    taken_reward_list\x18\x0b\x20\x03(\rR\x0ftakenRewardList\x12\x1b\n\tmax_\
    level\x18\x03\x20\x01(\rR\x08maxLevel\x12.\n\x13archive_unlock_list\x18\
