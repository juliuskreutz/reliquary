...
//! Generated file from `RecallPetCsReq.proto`
...
impl<'a> ::std::default::Default for &'a RecallPetCsReq {
    fn default() -> &'a RecallPetCsReq {
        <RecallPetCsReq as ::protobuf::Message>::default_instance()
    }
}

impl RecallPetCsReq {
    pub fn new() -> RecallPetCsReq {
...
impl ::protobuf::Message for RecallPetCsReq {
    const NAME: &'static str = "RecallPetCsReq";
...
impl ::protobuf::MessageFull for RecallPetCsReq {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("RecallPetCsReq").unwrap()).clone()
    }
}

impl ::std::fmt::Display for RecallPetCsReq {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for RecallPetCsReq {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}

static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x14RecallPetCsReq.proto\"8\n\x0eRecallPetCsReq\x12&\n\x0fsummoned_pet\
    _id\x18\x08\x20\x01(\rR\rsummonedPetIdB\x15\n\x13emu.lunarcore.protob\
    \x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(RecallPetCsReq::generated_message_descriptor_data());
