...
impl ::protobuf::Message for HomeChangeEditModeRsp {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.is_enter_edit_mode != false {
            os.write_bool(6, self.is_enter_edit_mode)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1bHomeChangeEditModeRsp.proto\"^\n\x15HomeChangeEditModeRsp\x12\x18\
    \n\x07retcode\x18\x02\x20\x01(\x05R\x07retcode\x12+\n\x12is_enter_edit_m\
    ode\x18\x06\x20\x01(\x08R\x0fisEnterEditModeB\x1b\n\x19emu.grasscutter.n\
    et.protob\x06proto3\
";
