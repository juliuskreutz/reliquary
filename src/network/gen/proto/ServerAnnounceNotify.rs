...
//! Generated file from `ServerAnnounceNotify.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_4_0;

// @@protoc_insertion_point(message:ServerAnnounceNotify)
...
impl<'a> ::std::default::Default for &'a ServerAnnounceNotify {
    fn default() -> &'a ServerAnnounceNotify {
        <ServerAnnounceNotify as ::protobuf::Message>::default_instance()
    }
}

impl ServerAnnounceNotify {
    pub fn new() -> ServerAnnounceNotify {
...
impl ::protobuf::Message for ServerAnnounceNotify {
    const NAME: &'static str = "ServerAnnounceNotify";
    ...
    fn new() -> ServerAnnounceNotify {
        ServerAnnounceNotify::new()
    }
...
impl ::protobuf::MessageFull for ServerAnnounceNotify {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("ServerAnnounceNotify").unwrap()).clone()
    }
}

impl ::std::fmt::Display for ServerAnnounceNotify {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for ServerAnnounceNotify {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}

static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1aServerAnnounceNotify.proto\x1a\x12AnnounceData.proto\"S\n\x14Serve\
    rAnnounceNotify\x12;\n\x12announce_data_list\x18\x02\x20\x03(\x0b2\r.Ann\
    ounceDataR\x10announceDataListB\x1b\n\x19emu.grasscutter.net.protob\x06p\
    roto3\
";
