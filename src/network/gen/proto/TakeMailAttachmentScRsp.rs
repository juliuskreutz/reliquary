...
impl ::protobuf::Message for TakeMailAttachmentScRsp {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(12, &self.succ_mail_id_list);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(12, &self.succ_mail_id_list)?;
        if let Some(v) = self.attachment.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1dTakeMailAttachmentScRsp.proto\x1a\x0eItemList.proto\"\x89\x01\n\
    \x17TakeMailAttachmentScRsp\x12)\n\x11succ_mail_id_list\x18\x0c\x20\x03(\
    \rR\x0esuccMailIdList\x12)\n\nattachment\x18\x0e\x20\x01(\x0b2\t.ItemLis\
