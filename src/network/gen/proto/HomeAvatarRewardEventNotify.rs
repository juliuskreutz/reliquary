...
impl ::protobuf::Message for HomeAvatarRewardEventNotify {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.is_event_trigger != false {
            os.write_bool(7, self.is_event_trigger)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x04\x20\x01(\x0b2\x1a.HomeAvatarRewardEventInfoR\x0brewardEvent\x12\
    =\n\x0cpending_list\x18\x0c\x20\x03(\x0b2\x1a.HomeAvatarRewardEventInfoR\
    \x0bpendingList\x12(\n\x10is_event_trigger\x18\x07\x20\x01(\x08R\x0eisEv\
