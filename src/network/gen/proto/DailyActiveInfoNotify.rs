...
impl ::protobuf::Message for DailyActiveInfoNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.daily_active_point != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.daily_active_point);
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(6, &self.daily_active_quest_id_list);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.daily_active_point != 0 {
            os.write_uint32(13, self.daily_active_point)?;
        }
        os.write_repeated_packed_uint32(6, &self.daily_active_quest_id_list)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x01\n\x15DailyActiveInfoNotify\x12,\n\x12daily_active_point\x18\r\x20\
    \x01(\rR\x10dailyActivePoint\x12:\n\x1adaily_active_quest_id_list\x18\
    \x06\x20\x03(\rR\x16dailyActiveQuestIdList\x12I\n\x17daily_active_level_\
    list\x18\n\x20\x03(\x0b2\x12.DailyActivityInfoR\x14dailyActiveLevelListB\
