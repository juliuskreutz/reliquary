...
//! Generated file from `RogueInfo.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_6_0;

// @@protoc_insertion_point(message:RogueInfo)
...
impl<'a> ::std::default::Default for &'a RogueInfo {
    fn default() -> &'a RogueInfo {
        <RogueInfo as ::protobuf::Message>::default_instance()
    }
}

impl RogueInfo {
    pub fn new() -> RogueInfo {
...
impl ::protobuf::Message for RogueInfo {
    const NAME: &'static str = "RogueInfo";
...
impl ::protobuf::MessageFull for RogueInfo {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("RogueInfo").unwrap()).clone()
    }
}

impl ::std::fmt::Display for RogueInfo {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for RogueInfo {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}

static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x0fRogueInfo.proto\x1a\x13RogueInfoData.proto\x1a\x16RogueCurrentInfo\
    .proto\"\x86\x01\n\tRogueInfo\x127\n\x0frogue_info_data\x18\xb2\x02\x20\
    \x01(\x0b2\x0e.RogueInfoDataR\rrogueInfoData\x12@\n\x12rogue_current_inf\
    o\x18\xfb\x07\x20\x01(\x0b2\x11.RogueCurrentInfoR\x10rogueCurrentInfoB\
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::RogueInfoData::file_descriptor().clone());
            deps.push(super::RogueCurrentInfo::file_descriptor().clone());
            let mut messages = ::std::vec::Vec::with_capacity(1);
            messages.push(RogueInfo::generated_message_descriptor_data());
