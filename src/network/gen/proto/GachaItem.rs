...
impl ::protobuf::Message for GachaItem {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.is_gacha_item_new != false {
            os.write_bool(11, self.is_gacha_item_new)?;
        }
        for v in &self.transfer_items {
            ::protobuf::rt::write_message_field_with_cached_size(12, v, os)?;
        };
        if self.is_flash_card != false {
            os.write_bool(14, self.is_flash_card)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    oto\"\xf4\x01\n\tGachaItem\x12)\n\ngacha_item\x18\x04\x20\x01(\x0b2\n.It\
    emParamR\tgachaItem\x122\n\x0ftoken_item_list\x18\t\x20\x03(\x0b2\n.Item\
    ParamR\rtokenItemList\x12)\n\x11is_gacha_item_new\x18\x0b\x20\x01(\x08R\
    \x0eisGachaItemNew\x129\n\x0etransfer_items\x18\x0c\x20\x03(\x0b2\x12.Ga\
    chaTransferItemR\rtransferItems\x12\"\n\ris_flash_card\x18\x0e\x20\x01(\
    \x08R\x0bisFlashCardB\x1b\n\x19emu.grasscutter.net.protob\x06proto3\
";
