...
//! Generated file from `ContentPackageData.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_6_0;

// @@protoc_insertion_point(message:ContentPackageData)
...
impl<'a> ::std::default::Default for &'a ContentPackageData {
    fn default() -> &'a ContentPackageData {
        <ContentPackageData as ::protobuf::Message>::default_instance()
    }
}

impl ContentPackageData {
    pub fn new() -> ContentPackageData {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "cur_content_id",
            |m: &ContentPackageData| { &m.cur_content_id },
...
impl ::protobuf::Message for ContentPackageData {
    const NAME: &'static str = "ContentPackageData";
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.cur_content_id != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.cur_content_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.cur_content_id != 0 {
            os.write_uint32(2, self.cur_content_id)?;
        }
    ...
    fn new() -> ContentPackageData {
        ContentPackageData::new()
    }
...
impl ::protobuf::MessageFull for ContentPackageData {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("ContentPackageData").unwrap()).clone()
    }
}

impl ::std::fmt::Display for ContentPackageData {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for ContentPackageData {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}

static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x18ContentPackageData.proto\x1a\x18ContentPackageInfo.proto\"\x81\x01\
    \n\x12ContentPackageData\x12E\n\x14content_package_list\x18\x0e\x20\x03(\
    \x0b2\x13.ContentPackageInfoR\x12contentPackageList\x12$\n\x0ecur_conten\
    t_id\x18\x02\x20\x01(\rR\x0ccurContentIdB\x15\n\x13emu.lunarcore.protob\
    \x06proto3\
";
