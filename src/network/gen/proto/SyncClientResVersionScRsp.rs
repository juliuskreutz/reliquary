...
//! Generated file from `SyncClientResVersionScRsp.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_6_0;

// @@protoc_insertion_point(message:SyncClientResVersionScRsp)
...
impl<'a> ::std::default::Default for &'a SyncClientResVersionScRsp {
    fn default() -> &'a SyncClientResVersionScRsp {
        <SyncClientResVersionScRsp as ::protobuf::Message>::default_instance()
    }
}

impl SyncClientResVersionScRsp {
    pub fn new() -> SyncClientResVersionScRsp {
...
impl ::protobuf::Message for SyncClientResVersionScRsp {
    const NAME: &'static str = "SyncClientResVersionScRsp";
    ...
    fn new() -> SyncClientResVersionScRsp {
        SyncClientResVersionScRsp::new()
    }
...
impl ::protobuf::MessageFull for SyncClientResVersionScRsp {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("SyncClientResVersionScRsp").unwrap()).clone()
    }
}

impl ::std::fmt::Display for SyncClientResVersionScRsp {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for SyncClientResVersionScRsp {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(SyncClientResVersionScRsp::generated_message_descriptor_data());
