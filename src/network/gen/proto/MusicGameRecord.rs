...
impl ::protobuf::Message for MusicGameRecord {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.max_combo != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.max_combo);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.max_combo != 0 {
            os.write_uint32(5, self.max_combo)?;
        }
        if self.is_unlock != false {
            os.write_bool(8, self.is_unlock)?;
        }
        if self.max_score != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x05\x20\x01(\rR\x08maxCombo\x12\x1b\n\tis_unlock\x18\x08\x20\x01(\
    \x08R\x08isUnlock\x12\x1b\n\tmax_score\x18\x01\x20\x01(\rR\x08maxScoreB\
