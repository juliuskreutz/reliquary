...
impl ::protobuf::Message for ChessRogueNousStoryInfo {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(1, &self.HCPCJBDBBGC);
        my_size += ::protobuf::rt::vec_packed_uint32_size(9, &self.INPDLILFOCO);
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(4, &self.CMHLEEKNFKH);
        if self.story_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(1, &self.HCPCJBDBBGC)?;
        os.write_repeated_packed_uint32(9, &self.INPDLILFOCO)?;
        if self.sub_story_id != 0 {
        ...
        os.write_repeated_packed_uint32(4, &self.CMHLEEKNFKH)?;
        if self.story_id != 0 {
