...
//! Generated file from `SellItemScRsp.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_6_0;

// @@protoc_insertion_point(message:SellItemScRsp)
...
impl<'a> ::std::default::Default for &'a SellItemScRsp {
    fn default() -> &'a SellItemScRsp {
        <SellItemScRsp as ::protobuf::Message>::default_instance()
    }
}

impl SellItemScRsp {
    pub fn new() -> SellItemScRsp {
...
impl ::protobuf::Message for SellItemScRsp {
    const NAME: &'static str = "SellItemScRsp";
...
impl ::protobuf::MessageFull for SellItemScRsp {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("SellItemScRsp").unwrap()).clone()
    }
}

impl ::std::fmt::Display for SellItemScRsp {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for SellItemScRsp {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}

static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x13SellItemScRsp.proto\x1a\x0eItemList.proto\"^\n\rSellItemScRsp\x123\
    \n\x10return_item_list\x18\x05\x20\x01(\x0b2\t.ItemListR\x0ereturnItemLi\
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(SellItemScRsp::generated_message_descriptor_data());
