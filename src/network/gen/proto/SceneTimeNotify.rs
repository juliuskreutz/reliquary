...
impl ::protobuf::Message for SceneTimeNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.scene_time != 0 {
            my_size += ::protobuf::rt::uint64_size(10, self.scene_time);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.scene_time != 0 {
            os.write_uint64(10, self.scene_time)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    d\x18\x05\x20\x01(\rR\x07sceneId\x12\x1b\n\tis_paused\x18\x08\x20\x01(\
    \x08R\x08isPaused\x12\x1d\n\nscene_time\x18\n\x20\x01(\x04R\tsceneTimeB\
