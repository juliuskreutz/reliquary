...
//! Generated file from `ChessRogueUpdateMoneyInfoScNotify.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_6_0;

// @@protoc_insertion_point(message:ChessRogueUpdateMoneyInfoScNotify)
...
impl<'a> ::std::default::Default for &'a ChessRogueUpdateMoneyInfoScNotify {
    fn default() -> &'a ChessRogueUpdateMoneyInfoScNotify {
        <ChessRogueUpdateMoneyInfoScNotify as ::protobuf::Message>::default_instance()
    }
}

impl ChessRogueUpdateMoneyInfoScNotify {
    pub fn new() -> ChessRogueUpdateMoneyInfoScNotify {
...
impl ::protobuf::Message for ChessRogueUpdateMoneyInfoScNotify {
    const NAME: &'static str = "ChessRogueUpdateMoneyInfoScNotify";
    ...
    fn new() -> ChessRogueUpdateMoneyInfoScNotify {
        ChessRogueUpdateMoneyInfoScNotify::new()
    }
...
impl ::protobuf::MessageFull for ChessRogueUpdateMoneyInfoScNotify {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("ChessRogueUpdateMoneyInfoScNotify").unwrap()).clone()
    }
}

impl ::std::fmt::Display for ChessRogueUpdateMoneyInfoScNotify {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for ChessRogueUpdateMoneyInfoScNotify {
