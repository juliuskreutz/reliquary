...
impl ::protobuf::Message for ChessRogueStartCsReq {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(8, &self.JDCMGPJHGLG);
        if self.KOLEFJKMFLF != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.KOLEFJKMFLF);
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(6, &self.DDDICOEFHPM);
        if self.area_id != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.area_id);
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(15, &self.base_avatar_id_list);
        my_size += ::protobuf::rt::vec_packed_uint32_size(13, &self.disable_aeon_id);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(8, &self.JDCMGPJHGLG)?;
        if self.KOLEFJKMFLF != 0 {
            os.write_uint32(1, self.KOLEFJKMFLF)?;
        }
        os.write_repeated_packed_uint32(6, &self.DDDICOEFHPM)?;
        if self.area_id != 0 {
            os.write_uint32(5, self.area_id)?;
        }
        os.write_repeated_packed_uint32(15, &self.base_avatar_id_list)?;
        os.write_repeated_packed_uint32(13, &self.disable_aeon_id)?;
        if self.dice_branch_id != 0 {
