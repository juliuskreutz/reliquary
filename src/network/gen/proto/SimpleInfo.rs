...
impl ::protobuf::Message for SimpleInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.chat_bubble_id != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.chat_bubble_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.chat_bubble_id != 0 {
            os.write_uint32(5, self.chat_bubble_id)?;
        }
        if self.online_status != ::protobuf::EnumOrUnknown::new(super::FriendOnlineStatus::FriendOnlineStatus::FRIEND_ONLINE_STATUS_OFFLINE) {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x10last_active_time\x18\x0b\x20\x01(\x03R\x0elastActiveTime\x12\x14\n\
    \x05level\x18\x0c\x20\x01(\rR\x05level\x12$\n\x0echat_bubble_id\x18\x05\
    \x20\x01(\rR\x0cchatBubbleId\x128\n\ronline_status\x18\x0e\x20\x01(\x0e2\
    \x13.FriendOnlineStatusR\x0conlineStatus\x12?\n\x12assist_simple_info\
    \x18\x01\x20\x03(\x0b2\x11.AssistSimpleInfoR\x10assistSimpleInfo\x12\x10\
    \n\x03uid\x18\x0f\x20\x01(\rR\x03uid\x12\x1b\n\tis_banned\x18\x04\x20\
    \x01(\x08R\x08isBanned\x12\x1b\n\thead_icon\x18\x08\x20\x01(\rR\x08headI\
    con\x122\n\rplatform_type\x18\x03\x20\x01(\x0e2\r.PlatformTypeR\x0cplatf\
    ormType\x12\x1c\n\tsignature\x18\x06\x20\x01(\tR\tsignature\x12\x1a\n\
    \x08nickname\x18\x07\x20\x01(\tR\x08nicknameB\x15\n\x13emu.lunarcore.pro\
    tob\x06proto3\
";
