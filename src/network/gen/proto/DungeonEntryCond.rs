...
impl ::protobuf::Message for DungeonEntryCond {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.cond_reason != ::protobuf::EnumOrUnknown::new(super::DungeonEntryBlockReason::DungeonEntryBlockReason::DUNGEON_ENTRY_REASON_NONE) {
            my_size += ::protobuf::rt::int32_size(2, self.cond_reason.value());
        }
        if self.param1 != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.param1);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.cond_reason != ::protobuf::EnumOrUnknown::new(super::DungeonEntryBlockReason::DungeonEntryBlockReason::DUNGEON_ENTRY_REASON_NONE) {
            os.write_enum(2, ::protobuf::EnumOrUnknown::value(&self.cond_reason))?;
        }
        if self.param1 != 0 {
            os.write_uint32(14, self.param1)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x10DungeonEntryCond\x129\n\x0bcond_reason\x18\x02\x20\x01(\x0e2\x18.Dun\
    geonEntryBlockReasonR\ncondReason\x12\x16\n\x06param1\x18\x0e\x20\x01(\r\
