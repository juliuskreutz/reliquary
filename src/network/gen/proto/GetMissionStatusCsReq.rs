...
//! Generated file from `GetMissionStatusCsReq.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_6_0;

// @@protoc_insertion_point(message:GetMissionStatusCsReq)
...
impl<'a> ::std::default::Default for &'a GetMissionStatusCsReq {
    fn default() -> &'a GetMissionStatusCsReq {
        <GetMissionStatusCsReq as ::protobuf::Message>::default_instance()
    }
}

impl GetMissionStatusCsReq {
    pub fn new() -> GetMissionStatusCsReq {
...
impl ::protobuf::Message for GetMissionStatusCsReq {
    const NAME: &'static str = "GetMissionStatusCsReq";
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(10, &self.sub_mission_id_list);
        my_size += ::protobuf::rt::vec_packed_uint32_size(11, &self.mission_event_id_list);
        my_size += ::protobuf::rt::vec_packed_uint32_size(8, &self.main_mission_id_list);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(10, &self.sub_mission_id_list)?;
        os.write_repeated_packed_uint32(11, &self.mission_event_id_list)?;
        os.write_repeated_packed_uint32(8, &self.main_mission_id_list)?;
    ...
    fn new() -> GetMissionStatusCsReq {
        GetMissionStatusCsReq::new()
    }
...
impl ::protobuf::MessageFull for GetMissionStatusCsReq {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("GetMissionStatusCsReq").unwrap()).clone()
    }
}

impl ::std::fmt::Display for GetMissionStatusCsReq {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for GetMissionStatusCsReq {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(GetMissionStatusCsReq::generated_message_descriptor_data());
